...
function main(data, threshold) {
    ...
    d3.select("#thresbut").select("p").text("Current Value: " + threshold)
    ...
    for(var i in data.steps) {
        ...
        // //Ensure the last node always appear
        // if(true || i == (data.steps.length - 1) || data.steps[i][threshValName] < threshold) {
        // //if(['5', '7', '12', '14', '15'].includes(data.steps[i].step)) {
        ...
        function update_nodes(root) {
            ...
            // var showDetails = document.getElementById("details").checked
                            ...
                            for(var prop in data.steps[0]) {
                                ...
                                if(prop.startsWith("_thrs_")) {
                                    n_group
                                        .append("text")
                                        .attr("text-anchor", node_anchor)
                                        .attr("y", propOffsetValue + node_y_offset + "em")
                                        .attr("x", node_x_offset + "em")
                                        // .attr("font-size", "smaller")
                                        .text(d => prop + ": " + d.data[prop]);
